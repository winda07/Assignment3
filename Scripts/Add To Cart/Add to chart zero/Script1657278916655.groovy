...
Mobile.tap(findTestObject('Add To Cart/btn_text_samsung_galaxy'), 0)
...
def toast = driver.findElementByXPath('//android.widget.Toast[@text=\'product quantity cannot be 0\']')
