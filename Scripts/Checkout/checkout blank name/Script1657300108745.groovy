...
Mobile.setText(findTestObject('checkout/set_name'), '', 0)

Mobile.verifyElementText(findTestObject('checkout/verify_element_name'), '', FailureHandling.OPTIONAL)
...
Mobile.verifyElementText(findTestObject('checkout/set_alertt'), 'please complete fill the form first!')
